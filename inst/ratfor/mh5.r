...
# 1 "cif.h" 1
  ##
  ## Map from 5 to conditional intensity functions etc
  ##
# 4 "methas.template" 2
# 1 "death.h" 1
# 5 "methas.template" 2

subroutine mh5(par,period,xprop,yprop,mprop,ntypes,
 ...
 if(urp>p) {
  ...
  ## Propose death:
   ...
   ## call aru(1,zero,one,iseed,xi)
    ...
    call straushm(x(ix),y(ix),mrki,ix,x,y,marks,ntypes,npts,par,period,cifval)
        ...
        ## call aru(1,zero,one,iseed,xi)
                 ...
                 v = yprop(irep)
                   ...
                   if(fixall && (mrk != mrki))
                     ...
                     call straushm(x(ix),y(ix),mrki,ix,x,y,marks,ntypes,npts,par,period,cvd)
